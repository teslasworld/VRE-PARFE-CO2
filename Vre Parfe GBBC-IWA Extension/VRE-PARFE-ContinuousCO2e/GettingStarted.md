...
- The next stage abbreviation profile has been defined as a scoped, lossless transport/view mapping. The canonical five-envelope model remains the source of truth.
...
The current package keeps the canonical envelope names as the source of truth:
